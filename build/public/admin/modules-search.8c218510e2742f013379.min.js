"use strict";(self.webpackChunknodebb=self.webpackChunknodebb||[]).push([[87527],{24601:(h,m,f)=>{var p,c;p=[f(42441),f(7927)],c=function(d,C){const g={};function v(o,l){return o.filter(function(e){return e.translations.toLowerCase().includes(l)}).map(function(e){const a=e.namespace,u=e.translations;let r=e.title;const n=utils.escapeRegexChars(l),s=u.replace(new RegExp("^(?:(?!"+n+").)*$","gmi"),"").replace(new RegExp("(^|\\n).*?"+r+".*?(\\n|$)","g"),"").replace(new RegExp("^[\\s\\S]*?(.{0,25})("+n+")(.{0,25})[\\s\\S]*?$","gmi"),'...$1<span class="search-match fw-bold">$2</span>$3...<br>').replace(/(?:\n ?)+/g,`
